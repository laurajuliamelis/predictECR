...
ui <- navbarPage(
  ...
  tags$p("DISCLAIMER: This tool is a research prototype and is not validated for clinical use.", style = "color: #db3d16; font-weight: bold; text-align:center;vertical-align: middle"),
  # 1. ECR Predictor
  tabPanel("ECR Predictor",
           fluidPage(
             sidebarLayout(
               sidebarPanel(
  ...
  tags$footer(
    tags$div(
      br(),
      tags$em("This study (PMP21/00085) was funded by Instituto de Salud Carlos III (ISCIII) 
       and funded by the European Union (NextGenerationUE- Recovery and Resilence Facility)"),
      br(),
      img(
